...
k_value
###Best way to select k value is by taking square root of nrow(train)
### thus k = 16.7332, hence optimal value is considered as 17
knn_fit <-
  knn(x_train, x_test, cl = y_train, k = 17)
